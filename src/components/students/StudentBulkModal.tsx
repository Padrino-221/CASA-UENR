        ...
        >
          ...
          {bulkFile ? (
            <div>
              ...
              <p className="text-xs text-slate-400 font-extrabold uppercase tracking-wider mt-1.5">Ready for processing</p>
            </div>
          ) : (
            <div>
              <h4 className="font-black text-[#0F172A] text-base">Select Roster File</h4>
